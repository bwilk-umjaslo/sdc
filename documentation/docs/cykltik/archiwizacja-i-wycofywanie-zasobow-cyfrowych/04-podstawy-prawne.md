...
Ustawa okreĹ›la zasady postÄ™powania z materiaĹ‚ami archiwalnymi i dokumentacjÄ… niearchiwalnÄ…, w tym obowiÄ…zki jednostek organizacyjnych w zakresie ewidencjonowania, przechowywania, ochrony, przekazywania i brakowania dokumentacji.
...
Przepisy o postÄ™powaniu z dokumentacjÄ… elektronicznÄ… wskazujÄ…, ĹĽe dokumenty w postaci elektronicznej wymagajÄ… odpowiednich metadanych, uporzÄ…dkowania, zabezpieczenia i moĹĽliwoĹ›ci dĹ‚ugotrwaĹ‚ego przechowywania. Kluczowe sÄ… relacje miÄ™dzy dokumentem, sprawÄ…, przesyĹ‚kÄ…, aktami sprawy i systemem, w ktĂłrym dokument powstaĹ‚ albo jest przechowywany.
...
Ustawa okreĹ›la ramy informatyzacji administracji publicznej, w tym znaczenie interoperacyjnoĹ›ci, systemĂłw teleinformatycznych, wymiany informacji w postaci elektronicznej i realizacji zadaĹ„ publicznych przy uĹĽyciu technologii.
...
Ustawa o dostÄ™pnoĹ›ci cyfrowej okreĹ›la wymagania dla stron internetowych i aplikacji mobilnych podmiotĂłw publicznych, deklaracji dostÄ™pnoĹ›ci, przeglÄ…du i aktualizacji deklaracji oraz postÄ™powania w sprawie zapewniania dostÄ™pnoĹ›ci cyfrowej.
...
RODO okreĹ›la zasady przetwarzania danych osobowych, w tym zgodnoĹ›Ä‡ z prawem, ograniczenie celu, minimalizacjÄ™, prawidĹ‚owoĹ›Ä‡, ograniczenie przechowywania, integralnoĹ›Ä‡, poufnoĹ›Ä‡ i rozliczalnoĹ›Ä‡. Ustawa o ochronie danych osobowych uzupeĹ‚nia krajowy system ochrony danych.
